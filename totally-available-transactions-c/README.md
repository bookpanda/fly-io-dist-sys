...
./maelstrom test -w txn-rw-register --bin ~/go/bin/totally-available-transactions --node-count 2 --concurrency 2n --time-limit 1 --rate 100 --consistency-models read-committed --availability total –-nemesis partition
